...
/**
 * Minimal Chat app install (Update-Mandatory-App-Rewrite.txt Phase 7).
 */
public class ChatInstall implements AppInstall
{
  private static final String APP_ID = "chat";
  private static final String APP_NAME = "Chat";
  private static final String APP_DESC = "Real-time messaging";
  private static final long NAV_SEQ = 17L;

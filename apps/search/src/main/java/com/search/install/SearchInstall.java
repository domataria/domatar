...
/**
 * Minimal Search app install (Update-Mandatory-App-Rewrite.txt Phase 7).
 */
public class SearchInstall implements AppInstall
{
  private static final String APP_ID = "search";
  private static final String APP_NAME = "Search";
  private static final String APP_DESC = "Search across Domatar";
  private static final long NAV_SEQ = 16L;
